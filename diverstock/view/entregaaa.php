       ...
       <?php rolvalidar(); ?>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                $result=$mysqli->query("SELECT * FROM detalle_prestamo WHERE id_prestamo='".$id=$_GET['entrega']."'") or die($mysqli->error);
                ?>                    
                    </div>
                </div>                   
                 <!-- /. ROW  -->
                  <hr />
                  <div>
                    <form action="processentrega.php" method="POST">
                       <table class="table table-bordered table-condensed table-hover">
                           ...
                           <tr>
                               ...
                               <td><button type="submit" class="btn btn-info" name="pres" >Entregar</button></td>
                           </tr>
                           <?php endwhile; ?>
                       </table>
                       </form>
