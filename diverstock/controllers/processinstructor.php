...
if (isset($_POST['save'])) {
	...
	//}
	//else{
         $datos=array("numidentifi_persona"=>$cedula,"nombre"=>$nombre,"apellido"=>$apellido,"correo"=>$correo,"genero"=>$genero,"estado"=>$estado,"celular"=>$celular,"fecha_nacimiento"=>$fecha,"especialidad"=>$carrera,"ficha"=>$ficha,"materia_explica"=>$materia,"cargo_de_bienestar"=>$w );
